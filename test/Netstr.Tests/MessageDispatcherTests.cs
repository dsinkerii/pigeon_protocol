    ...
    public class MessageDispatcherTests
    {
        ...
        public MessageDispatcherTests()
        {
            ...
            [
                ...
                new SubscribeMessageHandler(Mock.Of<IDbContextFactory<NetstrDbContext>>(), Mock.Of<IUserCache>(), [], Mock.Of<IOptions<LimitsOptions>>(), Mock.Of<IOptions<AuthOptions>>(), Mock.Of<ILogger<SubscribeMessageHandler>>()),
